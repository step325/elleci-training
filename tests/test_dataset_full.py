...
def test_dataset_comprehensive():
    ...
    print(f"✅ Phase 1 ratios: 55% EN / 35% IT / 10% Instr (~109K samples)")
    print(f"✅ Phase 2 ratios: 20% EN / 25% IT / 55% Instr (~109K samples)")
    print(f"✅ Instruction sources: Local (7.7K) + Fauno SO (47K) + Fauno Quora (54K)")
    ...
    print(f"✅ Phase 2 epochs: ~0.4 (prevents overfitting)")
    print("\n🎉 ALL TESTS PASSED!")
    print("="*80)
